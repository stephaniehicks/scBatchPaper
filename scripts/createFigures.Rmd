...
datapkgs_path <- "/net/irizarryfs01/srv/export/irizarryfs01_backed_up/share_root/shicks/dataPackages"
...
scores <- rbind(data.frame("CDR" = pdDeng$CDR, "Study"= rep(title.deng, nrow(pdDeng))),
                ...
                data.frame("CDR" = pdTENx$CDR, "Study"= rep(title.zheng, nrow(pdTENx))))
...
scores <- rbind(data.frame("CDR" = pdDeng$CDRlt1, 
                           "Study"= rep(paste0(title.deng, "\n(G=", nrow(eDeng),")"), nrow(pdDeng))),
                data.frame("CDR" = pdGuo$CDRlt1, 
                           "Study"= rep(paste0(title.guo, "\n(G=", nrow(eGuo),")"), nrow(pdGuo))),
                data.frame("CDR" = pdKowalczyk$CDRlt1, 
                           "Study"= rep(paste0(title.kowalczyk, "\n(G=", nrow(eKowalczyk),")"), nrow(pdKowalczyk))),
                data.frame("CDR" = pdKumar$CDRlt1, 
                           "Study"= rep(paste0(title.kumar, "\n(G=", nrow(eKumar),")"), nrow(pdKumar))),
                data.frame("CDR" = pdPatel$CDRlt1, 
                           "Study"= rep(paste0(title.patel, "\n(G=", nrow(ePatel),")*"), nrow(pdPatel))),
                data.frame("CDR" = pdTreutlein$CDRlt1, 
                           "Study"= rep(paste0(title.treutlein, "\n(G=", nrow(eTreutlein),")"), nrow(pdTreutlein))),
                data.frame("CDR" = pdShalek$CDRlt1, 
                           "Study"= rep(paste0(title.shalek.2014, "\n(G=", nrow(eShalek),")"), nrow(pdShalek))),
                data.frame("CDR" = pdTrapnell$CDRlt1, 
                           "Study"= rep(paste0(title.trapnell, "\n(G=", nrow(eTrapnell),")"), nrow(pdTrapnell))),
                data.frame("CDR" = pdBurns$CDRlt1, 
                           "Study"= rep(paste0(title.burns, "\n(G=", nrow(eBurns),")"), nrow(pdBurns))),
                data.frame("CDR" = pdLeng$CDRlt1, 
                           "Study"= rep(paste0(title.leng, "\n(G=", nrow(eLeng),")"), nrow(pdLeng))),
                data.frame("CDR" = pdJaitin$CDRlt1, 
                           "Study"= rep(paste0(title.jaitin, "\n(G=", nrow(eJaitin),")"), nrow(pdJaitin))),
                data.frame("CDR" = pdMacosko$CDRlt1, 
                           "Study"= rep(paste0(title.macosko, "\n(G=", nrow(eMacosko),")"), nrow(pdMacosko))),
                data.frame("CDR" = pdSatija$CDRlt1, 
                           "Study"= rep(paste0(title.satija, "\n(G=", nrow(eSatija),")"), nrow(pdSatija))),
                data.frame("CDR" = pdZeisel$CDRlt1, 
                           "Study"= rep(paste0(title.zeisel, "\n(G=", nrow(eZeisel),")"), nrow(pdZeisel))), 
                data.frame("CDR" = pdTENx$CDRlt1, 
                           "Study"= rep(paste0(title.zheng, "\n(G=", nrow(eTENx),")"), nrow(pdTENx))))
...
p.deng <- ggplot(melt(eDeng[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  ...
  xlab(x.title.lab) + labs(title = title.deng) + 
...
p.guo <- ggplot(melt(eGuo[,ind]), aes(x = value)) + geom_histogram(bins = 50) + 
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.guo) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.kowalczyk <- ggplot(melt(eKowalczyk[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.kowalczyk) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.kumar <- ggplot(melt(eKumar[,ind]), aes(x = value)) + geom_histogram(bins = 50) + 
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.kumar) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.patel <- ggplot(melt(patel_tpm[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.patel) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.treutlein <- ggplot(melt(eTreutlein[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.treutlein) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.shalek <- ggplot(melt(eShalek[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.shalek.2014) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.trapnell <- ggplot(melt(eTrapnell[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.trapnell) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.burns <- ggplot(melt(eBurns[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.burns) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.leng <- ggplot(melt(eLeng[,ind]), aes(x = value)) + geom_histogram(bins = 40) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.leng) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.jaitin <- ggplot(melt(eJaitin[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.jaitin) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.macosko <- ggplot(melt(eMacosko[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.macosko) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.satija <- ggplot(melt(eSatija[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.satija) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
p.zeisel <- ggplot(melt(eZeisel[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.zeisel) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))

p.zheng <- ggplot(melt(eTENx[,ind]), aes(x = value)) + geom_histogram(bins = 50) +
  geom_vline(aes(xintercept=1, color = "red"), size = 2) + 
  theme(legend.position = "none") + coord_cartesian(ylim=c(0, 1000)) + 
  xlab(x.title.lab) + labs(title = title.zheng) +
  theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_text(size = 20))
...
fig.hist.all15 <- plot_grid(p.deng, p.guo, p.kowalczyk, p.kumar, p.patel,
                        ...
                        p.jaitin, p.macosko, p.satija, p.zeisel, p.zheng, 
...
M <- 5e5
p <- pdTENx$CDR
scores <- data.frame(pdTENx,
                     "predMean" = p * log( (M / (nrow(eTENx)*p )) + 1)) 
PC1.Zheng <- ggplot(scores, aes(x = CDR, y = colMeans)) + 
    geom_point(size = 2, color = "black") + 
    xlab("Detection rate") + 
    ylab("Mean Cell Expression (log scale)") + 
    labs(title = paste0("Zheng et al., 2017")) + 
    theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_blank(), 
          legend.position="none") + 
...
fig2.all15 <- plot_grid(PC1.Deng.D, PC1.Guo.B, PC1.Kowalczyk, PC1.Kumar.A, PC1.Patel,
                        ...
                        PC1.Jaitin, PC1.Macosko, PC1.Satija, PC1.Zeisel.B, PC1.Zheng, 
                        labels = LETTERS[1:15], label_size = 25, ncol = 5)
fig2.all15
...
##### Figure: Zheng
scores <- data.frame(pdTENx, sTENx$v[, 1:3])
if(cor(scores$X1, scores$CDRlt1) < 0){ scores$X1 <- scores$X1*(-1) } 
fit.lo <- loess(scores$X1 ~ poly(scores$CDRlt1, degree = 1))
pc1Var <- c(sTENx$d^2 / sum(sTENx$d^2))[1]
PC1.Zheng <- ggplot(scores, aes(x = CDRlt1, y = X1)) + 
    geom_point(size = 2, color = "black") + 
    stat_smooth(method = "loess", formula = y ~ poly(x, degree = 1), 
                se = FALSE, span = 0.05, size = 2) + 
    ylab(paste0("Principal Component 1 (", round(pc1Var,2)*100, "%)")) + 
    xlab("Detection rate") + 
    labs(title = paste0("Zheng et al., 2017 (R^2: ", 
                        round(1 - var(fit.lo$residuals)/var(scores$X1), 2), ")")) + 
    theme(plot.title = element_text(size = 20),
          axis.text = element_text(size = 20), 
          axis.title = element_blank())
...
fit.lo <- loess(scores$X1 ~ poly(scores$CDR, degree = 1))
pc1Var <- c(sTENx$d^2 / sum(sTENx$d^2))[1]
PC1.Zheng <- ggplot(scores, aes(x = CDR, y = X1)) + 
    geom_point(size = 2, color = "black") + 
    stat_smooth(method = "loess", formula = y ~ poly(x, degree = 1), 
                se = FALSE, span = 0.05, size = 2) + 
    ylab(paste0("Principal Component 1 (", round(pc1Var,2)*100, "%)")) + 
...
# Patel 
data(patel_counts) # object name: patel_counts
patel_pd$cS = colSums(as.data.frame(as.matrix(assay(patel_counts)))) / 1e6
...
libSize_gse1 <- colSums(eset)/1e6
eset <- assays(gseObject_gene)[["TPM"]]
CDR_gse1 <- colMeans(eset > 1)
...
eset <- assays(gseObject_gene)[["count"]]
libSize_gse2 <- c(libSize, colSums(eset)/1e6)
eset <- assays(gseObject_gene)[["TPM"]]
CDR_gse2 <- c(CDR, colMeans(eset > 1))
 
pd <- data.frame("libSize"=c(libSize_gse1, libSize_gse2), "CDR" = c(CDR_gse1, CDR_gse2))
...
dat <- tidyQuants(as.matrix(eTENx), CDRval = pdTENx$CDRlt1, qRange = qVals)
pMed.Zheng <- ggplot(dat, aes(x = CDR, y = value, colour = Quantile)) +
    stat_smooth(method = "loess", formula = y ~ poly(x, degree = 1), 
                se = FALSE, span = 0.2, size = 2) + 
    geom_point(size = 2) + 
    xlab("Detection rate") + ylab("Expression (log2)") + 
    labs(title = title.zheng) + 
    theme(plot.title = element_text(size =20),
          axis.text = element_text(size = 20), 
          axis.title = element_blank(),  
          legend.position = "none")
...
pout <- plot_grid(pMed.Deng.D, pMed.Guo.A , pMed.Kowalczyk, pMed.Kumar.C, pMed.Patel,
                        ...
                        pMed.Jaitin, pMed.Macosko, pMed.Satija, pMed.Zeisel.B, pMed.Zheng,
                        labels = LETTERS[1:15], label_size = 25, ncol = 5)
...
pdf(file.path(working_path, "scBatchSuppFig-kaboxplot-legend.pdf"), width = 10, height = 5)
plot(p.legend)
dev.off()
...
# Figure - Bulk vs SC scatter and MA plot - Shalek et al. (2013)
```{r}
pdf(file.path(working_path, "Figure_scatter_reproduce_shalek.pdf"), width = 16, height = 8) 
...
# Figure - Bulk vs SC scatter plot (without curve)
```{r}
pdf(file.path(working_path, "Figure_scatter-withoutblueline.pdf"), width = 18, height =6) 
...
points(smDat$x, smDat$y, col = 2, pch = 17, cex = 2)
...
# Figure - Bulk vs SC scatter plot (with curve)
```{r}
